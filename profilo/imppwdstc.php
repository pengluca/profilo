...
function ControlloLunghezzaPassword(campo,nomeCampo)
{
   ...
   if (string.length<8)
   {
       alert("il campo "+nomeCampo+" deve contenere 8 Caratteri");
       campo.focus();
       campo.value="";
       return true;
   }
...
<form method="post" name="form1" action="php/pwdstc.php">
    ...
    <table height="100%" border=1 cellspacing=0>
      ...
      <table height="100%" cellpadding=6>
        ...
        <tr>
          ...
          <td><input name=nuova maxlength=8 size=12 value="" type=password></td>
        </tr>
        <tr>
          <td align="center"><B>Conferma password</B></td>
          <td><input name=conferma maxlength=8 size=12 value="" type=password></td>
        </tr>
        <tr>
